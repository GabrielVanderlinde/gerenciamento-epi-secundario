...
public class ColaboradorService {
    ...
    public ColaboradorService(ColaboradorRepository repo) { this.repo = repo; }
    ...
    public ColaboradorDTO criar(ColaboradorDTO dto) {
        if(repo.existsByNomeColaborador(dto.getNomeColaborador())) throw new RuntimeException("Nome duplicado.");
